...
import com.shu.domain.store.MediaProvider.Companion.COLUMN_DATE_ADDED
import com.shu.domain.store.MediaProvider.Companion.COLUMN_DATE_EXPIRES
import com.shu.domain.store.MediaProvider.Companion.COLUMN_DATE_MODIFIED
import com.shu.domain.store.MediaProvider.Companion.COLUMN_DATE_TAKEN
import com.shu.domain.store.MediaProvider.Companion.COLUMN_DURATION
import com.shu.domain.store.MediaProvider.Companion.COLUMN_HEIGHT
import com.shu.domain.store.MediaProvider.Companion.COLUMN_ID
import com.shu.domain.store.MediaProvider.Companion.COLUMN_IS_TRASHED
import com.shu.domain.store.MediaProvider.Companion.COLUMN_MEDIA_TYPE
import com.shu.domain.store.MediaProvider.Companion.COLUMN_MIME_TYPE
import com.shu.domain.store.MediaProvider.Companion.COLUMN_NAME
import com.shu.domain.store.MediaProvider.Companion.COLUMN_ORIENTATION
import com.shu.domain.store.MediaProvider.Companion.COLUMN_PATH
import com.shu.domain.store.MediaProvider.Companion.COLUMN_SIZE
import com.shu.domain.store.MediaProvider.Companion.COLUMN_WIDTH
import com.shu.domain.store.MediaProvider.Companion.EXTERNAL_CONTENT_URI
import com.shu.domain.store.MediaProvider.Companion.MEDIA_TYPE_IMAGE
import com.shu.domain.store.MediaProvider.Companion.MEDIA_TYPE_VIDEO
