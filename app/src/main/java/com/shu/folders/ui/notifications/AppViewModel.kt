...
import com.shu.folders.utils.applyGrayscaleFilter
import com.shu.folders.utils.copyImageFromStream
...
import com.shu.folders.utils.*

private const val FILEPATH_XML_KEY = "files-path"
private const val RANDOM_IMAGE_URL = "https://api.unsplash.com/photos/random?client_id=iIrd6bc63ZbCKba64QHWar3cn9ehwHoCcQPy8qX-eZs"
    ...
    fun loadImages() {
        viewModelScope.launch {
            val images = withContext(Dispatchers.IO) {
                imagesFolder.listFiles()?.toList() ?: emptyList()
            }
